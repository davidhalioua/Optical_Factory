...
export const getAllUsers = asyncHandler(async (req, res) => {
    console.log("📌 Requête reçue: GET /api/users"); // Log pour le debug
...
// ✅ Récupération du profil utilisateur (nécessite authentication)
...
// ✅ Récupérer un utilisateur par ID (NOUVELLE ROUTE AJOUTÉE)
